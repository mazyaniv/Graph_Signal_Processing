...
if __name__ == "__main__": #TODO RMSE (monte)
    my_parameters = prameters_class(M=20, N_q=0, SNR=0, K=500, D=2, teta_range=[-60, 60],monte=1,delta=5,Res=0.5)
    G_DOA(my_parameters)
    ...
    #
    # theta_fake = [35]
    # steering = Matrix_class(my_parameters).steering(theta_fake)
